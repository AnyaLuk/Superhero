...
function setup() {
  ...
  box1 = new Box(590, 100, 70, 70);
  box2 = new Box(590, 100, 70, 70);
  box3 = new Box(590, 100, 70, 70);
  box4 = new Box(590, 100, 70, 70);
  box5 = new Box(590, 100, 70, 70);
  box6 = new Box(590, 100, 70, 70);
